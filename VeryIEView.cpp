// VeryIEView.cpp : implementation of the CVeryIEView class
//
#include "stdafx.h"
#include "VeryIE.h"
#include "MainFrm.h"
...
// CVeryIEView
#ifndef USE_HTMLVIEW
IMPLEMENT_DYNCREATE(CVeryIEView, CFixedHtmlView)
#else
IMPLEMENT_DYNCREATE(CVeryIEView, CHtmlView)
#endif

#ifndef USE_HTMLVIEW
BEGIN_MESSAGE_MAP(CVeryIEView, CFixedHtmlView)
#else
BEGIN_MESSAGE_MAP(CVeryIEView, CHtmlView)
#endif
...
/////////////////////////////////////////////////////////////////////////////
// CVeryIEView construction/destruction
void CVeryIEView::SetSpecialProperty(DWORD dwNewProperty)
{
...
void CVeryIEView::SetDefaultProperty()
{
	m_dwProperty = m_dwPropertyDefault;
}

void CVeryIEView::SetFullProperty()
{
	m_dwProperty = 0;
...
BOOL CVeryIEView::PreCreateWindow(CREATESTRUCT& cs)
{
...
void CVeryIEView::OnInitialUpdate(int nOpenType, LPCSTR strUrl)
{
	try
	{
		m_bFirst = TRUE;
...
/////////////////////////////////////////////////////////////////////////////
// CVeryIEView diagnostics

#ifdef _DEBUG
void CVeryIEView::AssertValid() const
{
	CFixedHtmlView::AssertValid();
}

void CVeryIEView::Dump(CDumpContext& dc) const
{
...
/////////////////////////////////////////////////////////////////////////////
// CVeryIEView message handlers
void CVeryIEView::OnTitleChange(LPCTSTR lpszText)
{
	try{
...
void WBShowScrollBar(CVeryIEView* pvw)
{
	try
	{
...
void CVeryIEView::OnDocumentComplete(LPCTSTR lpszUrl)
{
...
void CVeryIEView::OnBeforeNavigate2(LPCTSTR lpszURL, DWORD /*nFlags*/,
...
void CVeryIEView::OnGoBack()
{
	if(m_bBack)
		GoBack();
}

void CVeryIEView::OnGoForward()
{
	if(m_bForward)
		GoForward();
}

void CVeryIEView::OnNewWindow2(LPDISPATCH* ppDisp, BOOL* Cancel) 
{
...
void CVeryIEView::OnProgressChange(long nProgress, long nProgressMax) 
{
	// TODO: Add your specialized code here and/or call the base class
	try{
...
BOOL CVeryIEView::OnAmbientProperty(COleControlSite* pSite, DISPID dispid, VARIANT* pvar) 
{
	// TODO: Add your specialized code here and/or call the base class
...
void CVeryIEView::OnOptionsLoadimage() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnUpdateOptions(CCmdUI* pCmdUI) 
{
...
void CVeryIEView::OnOptionsAllowscripts() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnOptionsLoadsounds() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnOptionsLoadvideos() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnOptionsUseWebp() 
{
	// TODO: Add your command handler code here
	if(m_bEnWebProxy)
		m_bEnWebProxy = FALSE;
...
void CVeryIEView::OnUpdateOptionsUseWebp(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	try
	{
...
void CVeryIEView::OnOptionsAllowactivex() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnOptionsAllowjavaapplet() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnCommandStateChange(long nCommand, BOOL bEnable) 
{
	// TODO: Add your specialized code here and/or call the base class
	if(nCommand == 2)
		m_bBack = bEnable;
...
void CVeryIEView::OnUpdateGoBack(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	try{
...
void CVeryIEView::OnUpdateGoForward(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	try{
...
void ResizeSibling(CVeryIEView* pvw)
{
	try{
	g_bMax = 0;
	CChildFrame* tcf;
...
void CVeryIEView::OnSize(UINT nType, int cx, int cy) 
{
	try
	{
		if(g_bMax==1)
...
void CVeryIEView::OnUpdateViewFonts(CCmdUI* pCmdUI) 
{ 
	// TODO: Add your command update UI handler code here
...
void CVeryIEView::ToNavigate(LPCTSTR URL, DWORD dwFlags, LPCTSTR lpszTargetFrameName, LPCTSTR lpszHeaders, LPVOID lpvPostData,  DWORD dwPostDataLen, BOOL bOnlyRefresh)
{
	try{
	CString str = URL;
	CString str2 = URL;
...
void CVeryIEView::OnParentNotify(UINT message, LPARAM lParam) 
{
...
void CVeryIEView::OnToolsAutoscrollAutoscrollingafterdownloading() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnUpdateToolsAutoscrollAutoscrollingafterdownloading(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->SetCheck(m_bScrollAfterDL);
}

void CVeryIEView::OnUpdateToolsAutoscrollSpeed(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	if(pmf->m_bMouseCtrlScrSpeed)
		pCmdUI->Enable(FALSE);
...
void CVeryIEView::OnToolsAutoscrollUseautoscrolling() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnUpdateToolsAutoscrollUseautoscrolling(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	try{
...
void CVeryIEView::ChangeSpeed(int nSpeed)
{
	if(m_nScrollTimer)
	{
		KillTimer(m_nScrollTimer);
...
void CVeryIEView::WBScroll()
{
	CVeryIEView* pvw = this;
	if(pvw->m_bToClose)
		return;
...
void CVeryIEView::WBScrollHPage(int bLeft)
{
	CVeryIEView* pvw = this;
	if(pvw->m_bToClose)
		return;
...
void CVeryIEView::WBScrollBy(long xpos,long ypos)
{
	CVeryIEView* pvw = this;
	if(pvw->m_bToClose)
		return;
...
void CVeryIEView::OnTimer(UINT nIDEvent) 
{
...
void CVeryIEView::ChangeProperty()
{
	try{
...
void CVeryIEView::OnNavigateComplete2(LPCTSTR lpszURL)
{
	try
	{
		CString strUrl;
...
void CVeryIEView::OnFileSavehtml() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnFilePrintSetup() 
{
	// TODO: Add your command handler code here
	ExecCommand(OLECMDID_PAGESETUP);
}

void CVeryIEView::OnFileProperty() 
{
	// TODO: Add your command handler code here
	ExecCommand(OLECMDID_PROPERTIES);
}

void CVeryIEView::ExecCommand(DWORD nCmdID)
{
...
void CVeryIEView::OnRButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	try{
...
void CVeryIEView::OnMouseMove(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	try{
...
void CVeryIEView::PushMouseGesture(char cDirection)
{
...
BOOL CVeryIEView::MoveDirection(CPoint &point, char *Direction)
{
...
CString CVeryIEView::GetSortSaveFileName(CString &ext)
{
	CString filename;
	int l;
...
void CVeryIEView::OnFileAutoSave() 
{
	// TODO: Add your command handler code here
	try{		
...
void CVeryIEView::OnLButtonUp(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
	if(m_bIsCapture)
	{
...
int CVeryIEView::MouseAction(int kind) 
{
	if (kind)
	{
		g_bRTab = FALSE;
...
CString CVeryIEView::GetPointUrl(POINT pt)
{
	CString strUrl;
	strUrl.Empty();
...
int CVeryIEView::OpenLinkUnderMouse(int nActive)
{
	POINT pt;
	GetCursorPos(&pt);
	ScreenToClient(&pt);
...
void CVeryIEView::VScrollPageUp()
{
	this->PostMessage(WM_KEYDOWN,VK_PRIOR,1);
}

void CVeryIEView::VScrollPageDown()
{
	this->PostMessage(WM_KEYDOWN,VK_NEXT,1);
}

void CVeryIEView::OnUpdateToolsAutoscrollPage(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	switch(pCmdUI->m_nID)
	{
...
void CVeryIEView::OnViewPagesize50() 
{
	// TODO: Add your command handler code here
...
void CVeryIEView::OnViewPagesize100() 
{
	// TODO: Add your command handler code here
	pmf->m_bShowScriptResult = false;
...
void CVeryIEView::OnViewPagesize200() 
{
	// TODO: Add your command handler code here
	pmf->m_bShowScriptResult = false;
...
void CVeryIEView::OnViewPagesizeAdd10() 
{
	// TODO: Add your command handler code here
	pmf->m_bShowScriptResult = false;
...
void CVeryIEView::OnViewPagesizeDec10() 
{
	// TODO: Add your command handler code here
	pmf->m_bShowScriptResult = false;
...
void CVeryIEView::OnFileImportExport() 
{
	// TODO: Add your command handler code here
	try{
...
void CVeryIEView::OnFileAutoSaveSort() 
{
	// TODO: Add your command handler code here
	m_bSortSave = TRUE;
	OnFileAutoSave();

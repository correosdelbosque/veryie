// VeryIENSHandle.cpp : Implementation of CVeryIEApp and DLL registration.
...
CVeryIENSHandle::CVeryIENSHandle()
{
}

STDMETHODIMP CVeryIENSHandle::Start(
        LPCWSTR szUrl,
...
STDMETHODIMP CVeryIENSHandle::Continue(PROTOCOLDATA *pStateInfo)
{
	return S_OK;
}

STDMETHODIMP CVeryIENSHandle::Abort(HRESULT hrReason,DWORD dwOptions)
{
	return E_NOTIMPL;
}

STDMETHODIMP CVeryIENSHandle::Terminate(DWORD dwOptions)
{
	return  S_OK;
}

STDMETHODIMP CVeryIENSHandle::Suspend()
{
...
STDMETHODIMP CVeryIENSHandle::Resume()
{
...
STDMETHODIMP CVeryIENSHandle::Read(void *pv, ULONG cb, ULONG *pcbRead)
{
	try{
...
STDMETHODIMP CVeryIENSHandle::Seek(
...
STDMETHODIMP CVeryIENSHandle::LockRequest(DWORD dwOptions)
{
...
STDMETHODIMP CVeryIENSHandle::UnlockRequest()
{
...
STDMETHODIMP CVeryIENSHandle::CombineUrl(LPCWSTR pwzBaseUrl, LPCWSTR pwzRelativeUrl, DWORD dwCombineFlags,
...
STDMETHODIMP CVeryIENSHandle::CompareUrl(LPCWSTR pwzUrl1, LPCWSTR pwzUrl2, DWORD dwCompareFlags)
{
...
STDMETHODIMP CVeryIENSHandle::ParseUrl(LPCWSTR pwzUrl, PARSEACTION ParseAction, DWORD dwParseFlags,
	LPWSTR pwzResult, DWORD cchResult, DWORD *pcchResult, DWORD dwReserved)
{
...
STDMETHODIMP CVeryIENSHandle::QueryInfo( LPCWSTR pwzUrl, QUERYOPTION QueryOption, DWORD dwQueryFlags,
